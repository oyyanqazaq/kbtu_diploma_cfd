...
% мы ссылаемся на старый проект, при таких значениях наша вычислительная мозность
% выдала такие результаты, поэтому мы scale = 1/13 () пропорционально по мощности

%  36 метр - здание с севера
%  30 метр - следущее
%  39 метр - здание с юга
%  39 метр - самый южный
%  
